      ...
      <section className="text-gray-600 body-font">
        ...
        >
          ...
          >
            ...
            >
              <div
                className="relative mr-4 md:w-full lg:w-full xl:w-1/2 w-2/4"
                bis_skin_checked="1"
              >
            ...
            <div className="flex lg:flex-row md:flex-col" bis_skin_checked="1">
          ...
          >
            <img
              className="object-cover h-96 w-96 object-center rounded"
              alt="hero"
              src="https://images.pexels.com/photos/20465954/pexels-photo-20465954.jpeg"
            />
          </div>
        </div>
      </section>
